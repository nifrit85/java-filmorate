...
class FilmControllerTest {
    ...
    void testPutGood() {
        ...
        Film filmToUpdate = Film.builder().id(film.getId()).name("Good film update").description("Very good film updated").releaseDate(film.getReleaseDate().plusDays(1)).duration(96L).build();
